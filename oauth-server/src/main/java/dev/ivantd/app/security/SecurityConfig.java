...
/**
 * https://youtu.be/oHiIBkSv3nw?si=IbmRubNFxRJ6M4Un
 */
@Configuration
@EnableWebSecurity
public class SecurityConfig {
	...
	public RegisteredClientRepository registeredClientRepository() {
			...
			RegisteredClient oidcClient = RegisteredClient.withId(UUID.randomUUID().toString())
				...
				// Es la URL a la que se redirige al usuario una vez que se ha autenticado junto con el código de autorización
	...
	/**
	 * Genera un par de claves RSA (pública y privada) para firmar los tokens JWT
	 * Se utiliza para codificar y decodificar los tokens JWT
	 * @return
	 */
	@Bean 
